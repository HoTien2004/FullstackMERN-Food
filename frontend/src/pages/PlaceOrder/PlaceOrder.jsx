        ...
        <form onSubmit={placeOrder} className='place-order'>
            <div className="place-order-left">
                ...
                <div className="multi-fields">
                    ...
                    <input required name='district' onChange={onChangeHandler} value={data.district} type="text" placeholder='Quận' />
                </div>
                <div className="multi-fields">
                    <input required name='zipcode' onChange={onChangeHandler} value={data.zipcode} type="text" placeholder='Mã vùng' />
